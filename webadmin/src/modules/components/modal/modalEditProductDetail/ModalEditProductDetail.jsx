        ...
        <div>
          ...
          >
            <div>
              ...
              />
              {listError.quantity && (
                <label className="error-text">{listError.quantity}</label>
              )}
              <InputAdmin
                label={"Giá bán"}
                name={"price"}
              ...
              />
              {listError.price && (
                <label className="error-text">{listError.price}</label>
              )}
            ...
            <div className="select-edit">
              ...
              <Select
                ...
                onChange={(selectedOption) =>
                  handleChangeColor(selectedOption, "color", "createColor")
                }
                isClearable
                isSearchable
              ...
              />
              {listError.colorCode && (
                <label className="error-text">{listError.colorCode}</label>
              )}
            </div>
