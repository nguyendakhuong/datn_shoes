...
const OtherTrademark = () => {
    ...
    try {
      ...
      if (data.status === 200) {
        ...
        const uniqueTrademarks = [
          ...new Set(data.data.map((item) => item.trademark)),
        ];
  ...
  useEffect(() => {
    if (trademark && trademark.toLowerCase() !== "all") {
    ...
    <div className="other-container">
      <div className="filter-container">
        ...
        <div className="btn-filter">
          <button onClick={() => setPriceFilter(priceFilterTemp)}>
            Lọc theo giá
          </button>
        </div>
        ...
        <div className="select-filter">
          <select
            ...
            onChange={(e) => {
              ...
              navigate(`/otherTrademark/${value || "all"}`);
            }}
          >
