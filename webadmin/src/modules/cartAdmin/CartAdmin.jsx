...
const CartAdmin = () => {
  ...
  const getProductActive = async () => {
    try {
      const response = await fetch(
        `http://localhost:3001/product/productActive`,
        {
          headers: {
  ...
  const getOrderByAdmin = async () => {
    try {
      const response = await fetch(
        `http://localhost:3001/order/getOrderAdmin`,
        {
          headers: {
            Authorization: `Bearer`,
            "Content-Type": "application/json",
  ...
  const getOrderAdminByCode = async () => {
    try {
      const response = await fetch(
        `http://localhost:3001/order/getOrderAdminByCode/${selectedOrderCode}`,
        {
          headers: {
            Authorization: `Bearer`,
          },
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async () => {
          try {
            const response = await fetch(
              `http://localhost:3001/order/payOrderAdmin/${selectedOrderCode}`,
              {
                method: "POST",
                headers: {
                  Authorization: `Bearer `,
  ...
  const handleDiscount = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:3001/discount/useDiscountAdmin",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async () => {
          ...
          try {
            const response = await fetch(
              `http://localhost:3001/order/createOrderAdmin`,
              {
                method: "GET",
                headers: {
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async () => {
          try {
            const response = await fetch(
              `http://localhost:3001/order/addProductToOrderAdmin/${selectedOrderCode}`,
              {
                method: "POST",
                headers: {
                  Authorization: `Bearer `,
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async () => {
          ...
          try {
            const response = await fetch(
              `http://localhost:3001/order/deleteOrderAdminByCode/${orderCode}`,
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                  "Content-Type": "application/json",
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async () => {
          ...
          try {
            const response = await fetch(
              `http://localhost:3001/order/deleteOrderDetail/${orderDetailCode}`,
              {
                headers: {
                  Authorization: `Bearer ${token}`,
                  "Content-Type": "application/json",
    ...
    dispatch({
      ...
      payload: {
        ...
        onClickConfirmModel: async (quantity, listError) => {
          ...
          try {
            const response = await fetch(
              `http://localhost:3001/order/updateQuantityOrderDetail/${orderDetailCode}`,
              {
                method: "POST",
                headers: {
                  Authorization: `Bearer `,
  ...
  const filteredProducts = dataProductActive.filter((product) =>
    String(product.productDetailCode)
      .toLowerCase()
    ...
    <div className="cartAdmin-container">
              ...
              {dataOrderDetail.length > 0
                ? dataOrderDetail.map((product, index) => (
                    <tr
                      ...
                      className="orderAdmin"
                      onClick={() =>
                        handleUpdateQuantityProduct(product.orderDetailCode)
                      }
                    >
      ...
      <div className="form-total">
        <div className="input-info">
          ...
          />
          {listError.name && (
            <label className="error-text">{listError.name}</label>
          )}
          <InputAdmin
            label={"Số điện thoại"}
            name={"phoneNumber"}
          ...
          {listError.phoneNumber && (
            <label className="error-text">{listError.phoneNumber}</label>
          )}
        </div>
